...
const DecoratedInstanceOfStandardComponent = withReducer(reducer, 'standard')(MyStandardComponent).createInstance('instance')
const DecoratedInstanceOfStatelessComponent = withReducer(reducer, 'stateless')(MyStatelessComponent).createInstance('instance')

const DecoratedStandardComponentWithExtraState = withReducer(reducer, 'standard')(MyStandardComponent).withExtraState((state: {}) => ({ test: "value" }))
const DecoratedStatelessComponentWithExtraState = withReducer(reducer, 'standard')(MyStatelessComponent).withExtraState((state: {}) => ({ test: "value" }))
